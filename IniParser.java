...
public class IniParser {
        ...
        try {
            ...
            while((line = br.readLine()) != null){
                ...
                if (startSection != -1 && endSection != -1 && endSection > startSection){
                    String section = lastSection = line.substring(startSection+1, endSection - startSection);
                    ...
                    if (hasComments == -1){
                        ...
                        HashMap<String, Object> hash = data.get(lastSection);
                        hash.put(keyValue[0].trim(),keyValue[1].trim().substring(0,hasComments));
                    }
                }else{
    ...
    public void addString(String section, String key, String value){
        if(!data.containsKey(section)){
            throw new IllegalArgumentException("Section " + section + " doesn't exist");
        }
